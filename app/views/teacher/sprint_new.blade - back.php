   ...
   <!-- headerbar -->
    ...
    <div class="contentpanel">   
      ...
      <div class="row">
        ...
        @else 
          <input type="text" name="course" id="course" value="{{$sprintById->course}}">
        @endif
          ...
          <div class="panel-footer">
           <div class="form-actions right">
            <div class="col-sm-12 col-sm-offset-3">
              ...
              @if ($course > 0)
              <a href="{{URL::route('teacher/sprintsBycourse', $course)}}" class="btn btn-default"> Cancel</a> 
              @else
...
{{HTML::script('assets/js/jquery_uploader/load-image.min.js')}}
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
{{HTML::script('assets/js/jquery_uploader/canvas-to-blob.min.js')}}
