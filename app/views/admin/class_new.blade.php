...
<div class="pageheader">
  <h2><i class="fa fa-suitcase"></i> Add New Class <span></span></h2>
...
{{Form::open(array('url' => 'class/add', 'method' => 'post', 'class' => 'form-horizontal form-bordered', 'id' => 'submit_form', 'autocomplete' => 'off'))}}           
