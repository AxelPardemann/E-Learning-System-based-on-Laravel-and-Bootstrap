...
<div class="contentpanel">
  ...
  @endif  
	<div class="row">
      <div class="col-md-12">          
          {{Form::open(array('url' => 'user/update', 'method' => 'post', 'class' => 'form-horizontal', 'id' => 'userEdit', 'autocomplete' => 'off'))}}
                ...
                <div class="row">
                    <div class="col-md-6 mb10">
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <input type="text" name="firstname" placeholder="First Name" class="form-control" value="{{$userById->first}}">
                          </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb10">
                        <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <input type="text" name="lastname" placeholder="Last Name" class="form-control" value="{{$userById->last}}">
                          </div>
                        </div>
                    </div>                
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <select class="form-control chosen-select" data-placeholder="Permission" name="permission">
                                  <option value=""></option>
                                  @if ($userById != null && $userById->permission == "administrator")
                                  <option value="administrator" selected>Administrator</option>
                                  <option value="teacher">Teacher</option>
                                  <option value="student">Student</option>
                                  @elseif ($userById != null && $userById->permission == "teacher")
                                  <option value="administrator">Administrator</option>
                                  <option value="teacher" selected>Teacher</option>
                                  <option value="student">Student</option>
                                  @elseif ($userById != null && $userById->permission == "student")
                                  <option value="administrator">Administrator</option>
                                  <option value="teacher">Teacher</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            @if ($userById != null && $userById->published == 1)
                            ...
                            @elseif($userById != null && $userById->published == 0)
                  ...
                  <div class="row">
                      <div class="col-md-6 mb10">
                          <div class="form-group">
                            ...
                            <div class="col-sm-7">
                              <input type="text" name="email" placeholder="Email" class="form-control" readonly value="{{$userById->email}}">
                            </div>
                          </div>
                      </div>
                      <div class="col-md-6 mb10">
...
<script>
    jQuery(document).ready(function(){
		...
		FormValidation.init();     
    jQuery('select[name=country]').val('{{$userById->country}}');
    jQuery('select[name=permission]').val('{{$userById->permission}}');
    var birthday = '{{$userById->birthday}}'
